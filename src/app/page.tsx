...
export default function LandingPage() {
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem("ascend_landing_theme") as "light" | "dark" | null;
  ...
  const toggleTheme = () => {
    ...
    setTheme(newTheme);
    localStorage.setItem("ascend_landing_theme", newTheme);
  ...
  const capabilities: { icon: LucideIcon; title: string; body: string }[] = [
    ...
    },
    {
      ...
      body: "Validated contracts, immutable audit trails, and a single glossary of approved terminology — no improvised labels.",
    },
    {
      icon: KeyRound,
    ...
    },
    {
      ...
      body: "Feature-based folders, predictable stores, and a Tailwind theme ready to ship — without rewriting the shell.",
    },
  ];
